-- Only load the rsync module if the corresponding .rsync.json file is found
local rsync_root = vim.fs.root(0, ".rsync.json")
if rsync_root ~= nil then
  vim.pack.add({
...
-- Only load the REPL module if the corresponding .repl.sh file is found
